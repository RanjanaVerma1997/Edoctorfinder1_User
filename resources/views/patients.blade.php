				...
				<div class="row">
					<div class="col">
						<div class="home_content">
							<div class="home_title">Patients</div>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col text-center">
					<div class="section_title">Our Patients</div>
			...
			<div class="row doctors_row">
				...
				<div class="col-xl-3 col-md-6">
					<div class="doctor">
						<div class="pat_image"><a href="{{ route('pat_image',['id'=>$patient->id])}}"><img src="{{asset('images/'.$patient->pat_image)}}" height="280" width="220"></a></div>
						<div class="doctor_content">
							<div class="doctor_name"><a href="#">{{$patient->pat_name}}</a></div>
